...
<form action="<?= base_url('create-category') ?>" method="post" class="default-form">
    <div class="input-wrapper">
        ...
        <input type="text" name="name" id="name" placeholder="<?= LANG->categories->attributes->name ?>" required />
    </div>
    <div class="input-wrapper">
